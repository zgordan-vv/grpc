...
var file_greet_greetpb_greet_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x32, 0xe5, 0x02, 0x0a,
	...
	0x47, 0x72, 0x65, 0x65, 0x74, 0x44, 0x4c, 0x12, 0x13, 0x2e, 0x67, 0x72, 0x65, 0x65, 0x74, 0x2e,
...
var file_greet_greetpb_greet_proto_depIdxs = []int32{
	...
	1, // 8: greet.GreetService.GreetDL:input_type -> greet.GreetRequest
	...
	2, // 13: greet.GreetService.GreetDL:output_type -> greet.GreetResponse
...
type GreetServiceClient interface {
	...
	GreetDL(ctx context.Context, in *GreetRequest, opts ...grpc.CallOption) (*GreetResponse, error)
}
...
func (c *greetServiceClient) GreetDL(ctx context.Context, in *GreetRequest, opts ...grpc.CallOption) (*GreetResponse, error) {
	out := new(GreetResponse)
	err := c.cc.Invoke(ctx, "/greet.GreetService/GreetDL", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GreetServiceServer interface {
	...
	GreetDL(context.Context, *GreetRequest) (*GreetResponse, error)
}
...
func (*UnimplementedGreetServiceServer) GreetDL(context.Context, *GreetRequest) (*GreetResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GreetDL not implemented")
}
...
func _GreetService_GreetDL_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GreetRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GreetServiceServer).GreetDL(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/greet.GreetService/GreetDL",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreetServiceServer).GreetDL(ctx, req.(*GreetRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _GreetService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GreetDL",
			Handler:    _GreetService_GreetDL_Handler,
		},
	},
